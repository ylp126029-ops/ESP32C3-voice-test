...
#include "widgets_init.h"
	...
	LV_IMAGE_DECLARE(gif4);
	LV_IMAGE_DECLARE(gif5);
	LV_IMAGE_DECLARE(gif6);
	LV_IMAGE_DECLARE(gif7);
	...
	LV_IMAGE_DECLARE(straight5);
	LV_IMAGE_DECLARE(straight6);
	LV_IMAGE_DECLARE(straight7);
	LV_IMAGE_DECLARE(straight8);
	LV_IMAGE_DECLARE(straight9);
#ifdef __cplusplus
}
#endif
#endif
