...
void setup_scr_E_8(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->E_8_animimg_1, 20, 20);
    lv_obj_set_size(ui->E_8_animimg_1, 200, 200);
    lv_animimg_set_src(ui->E_8_animimg_1, (const void **) E_8_animimg_1_imgs, 21);
    lv_animimg_set_duration(ui->E_8_animimg_1, 21*30);
    lv_animimg_set_repeat_count(ui->E_8_animimg_1, LV_ANIM_REPEAT_INFINITE);
    // lv_animimg_start(ui->E_8_animimg_1);
    lv_image_set_src(ui->E_8_animimg_1, E_8_animimg_1_imgs[0]);
